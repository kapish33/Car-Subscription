...
describe('User API Endpoints', () => {
  ...
  describe('GET /users/:id', () => {
    it('should return a user for a valid ID', async () => {
      ...
      const expectedUser = users.find((user: Partial<User>) => user._id === testId) as User;
    ...
    it('should return a not found error for non-existent ID', async () => {
      ...
      // Assert
      expect(response.statusCode).toEqual(StatusCodes.INTERNAL_SERVER_ERROR); // will fail and will give BAD_REQUEST
